...
const SOURCE: Record<SettingKey, unknown> = {
  ...
  'recording.domMutations': constants.CAPTURE_DOM_MUTATIONS,
  'recording.domMutationCap': constants.DOM_MUTATION_CAP,
  'recording.domMaxChanges': constants.DOM_MAX_CHANGES,
  'recording.containerTextCap': constants.CONTAINER_TEXT_CAP,
  'recording.state': constants.CAPTURE_STATE,
  'recording.stateSettleMs': constants.STATE_SETTLE_MS,
  'recording.stateMaxDepth': constants.STATE_MAX_DEPTH,
  'recording.stateMaxKeys': constants.STATE_MAX_KEYS,
  'recording.stateMaxEntries': constants.STATE_MAX_ENTRIES,
  'recording.stateStringCap': constants.STATE_STRING_CAP,
  'recording.stateMaxStores': constants.STATE_MAX_STORES,
  ...
  'react.useSourceMaps': constants.USE_SOURCE_MAPS,
  'locator.hidden.routing': constants.HIDE_COMPONENT_CATEGORY,
  'locator.hidden.providers': constants.HIDE_COMPONENT_CATEGORY,
  'locator.hidden.react': constants.HIDE_COMPONENT_CATEGORY,
  'locator.hidden.styling': constants.HIDE_COMPONENT_CATEGORY,
  'locator.hidden.dependency': constants.HIDE_COMPONENT_CATEGORY,
 ...
 * it — and only for whoever ran `npx devflow-mcp-server`, not for anyone here.
 */
